...
async function fetchItems() {
  ...
  const baseUrl =
    process.env.NODE_ENV === "production" && typeof window === "undefined"
      ? "http://localhost:3000" // порт tereamsk.ru контейнера
      : "http://localhost:3000"; // в браузере или разработке - относительный путь
...
export async function generateMetadata() {
  ...
  return {
    ...
    openGraph: {
      title,
      description:
        "IQOS ILUMA в Москве для стиков TEREA. Все модели, гарантия.",

...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://tereamsk.ru/blog/${article.slug}`,
    },
    openGraph: {
      title: article.title,
      description: article.metaDescription || article.description,
      url: `https://tereamsk.ru/blog/${article.slug}`,
      type: "article",
...
export default function ArticlePage({ params }) {
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Главная",
        item: "https://tereamsk.ru",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "Блог",
        item: "https://tereamsk.ru/blog",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: article.title,
        item: `https://tereamsk.ru/blog/${article.slug}`,
      },
    ],
  };
  ...
  const articleSchema = {
    ...
    publisher: {
      ...
      logo: {
        "@type": "ImageObject",
        url: "https://tereamsk.ru/logo.png",
      },
    },
    mainEntityOfPage: {
      "@type": "WebPage",
      "@id": `https://tereamsk.ru/blog/${article.slug}`,
    },
  };
